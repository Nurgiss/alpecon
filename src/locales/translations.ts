  ...
  ru: {
    ...
    home: {
      ...
      aboutSection: {
        ...
        text: "Alpecon Group - современная агропромышленная компания из Казахстана, специализирующаяся на глубокой переработке овощей и фруктов для внутреннего потребления и международных рынков.\n\nМы создаем натуральную продукцию высокого качества, используя современные технологии переработки и устойчивые экологические практики.\n\nНаша бизнес-модель основана на долгосрочных экспортных контрактах, поддержке локальных фермеров и развитии сельских территорий."
      },
      stats: {
        title: "Мы в цифрах",
